...
## Git and Github Desktop - (program for version control) {#git}
...
[Github Desktop](https://desktop.github.com/) is an app that simplifies using Git. The app allows you to interact with github via a graphical interface which allows you to perform common git commands without the hassle of using the command line.
...
## Using Git, Github Desktop & GitHub Effectively {#effective_vc}
...
* You could check out [Getting started with Github desktop](https://docs.github.com/en/desktop/installing-and-configuring-github-desktop/overview/getting-started-with-github-desktop), for an overview of how to set up and use.
...
See the [appendix](#workflow) for a general approach to version control at GAD.
...
## GADHUB
[GADHUB](https://github.com/GADHUB) is GAD's github organisation and the place where we store our code repositories. You will need a [GitHub](https://github.com/) account before you can join and get access to GADHUB. Once you have created you account (please use a gad email address and using a handle that includes you name) let the Development team know and they can sent you an invite to join.
...
## Github Desktop & GitHub at GAD
At present, GAD base machines do not have git or github desktop by default.

You may be able to install on the modelling servers - look in C:\\temp - for installers. If in doubt please contact the development team and/or IT.
